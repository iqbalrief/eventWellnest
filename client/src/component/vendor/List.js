...
function List() {
  ...
  {vendorData ? (
  <div>
    <p>ID: {vendorData.dataVendor.id}</p>
    <p>Username: {vendorData.dataVendor.username}</p>
    <p>Lastname: {vendorData.dataVendor.lastname}</p>
    <p>Email: {vendorData.dataVendor.email}</p>
    <p>Vendor Name: {vendorData.dataVendor.vendorName}</p>
  </div>
) : (
  <p>Loading...</p>
)}
