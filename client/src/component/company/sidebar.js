    ...
    <aside className="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
        <div>
            <div className="-mx-6 px-6 py-4">
                <a href="#" title="home">
                    <img src="https://www.emprenderconactitud.com/img/POC%20WCS%20(1).png" className="w-40" alt="POC WCS"/>
                </a>
            </div>
            <ul className="space-y-2 tracking-wide mt-8">
                <li>
                   
                    <NavLink to="/company"  aria-label="dashboard" className="relative px-4 py-3 flex items-center space-x-4 rounded-lg text-white bg-gradient-to-r from-sky-600 to-cyan-400">
                        <svg className="h-6 w-6 text-white"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  
                ...
                <li>
                    ...
                    <NavLink to="/event" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-700 group">
                       <span className="group-hover:text-gray-700">Event</span>
                    </NavLink>
                </li>
                <li>
                    <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-700 group">
                        <svg className="h-6 w-6 text-gray-700"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2"stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  
